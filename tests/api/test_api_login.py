...
from flask_cookie.exceptions import UnauthorizedException
...
@mock.patch("flask_cookie.services.auth.login")
...
def test_should_return_invalid_login(client):
    ...
    with mock.patch("flask_cookie.services.auth.login") as auth_mock:
